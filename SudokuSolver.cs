...
namespace CNNAlgorithm
{
	...
	class SudokuSolver : ISudokuSolver
	{
		...
		private const string modelPath = @"C:\Users\vadaz\Documents\BIG_DATA\05\Big_Data_C_Computing\SUDOKU_\CNNAlgorithm\Models\sudoku.model";
	...
	public class NeuralNetHelper
	{
		...
		{
			var distributionPath = @"C:\Users\vadaz\AppData\Local\Programs\Python\Python37";
			...
			//PythonEngine.PythonHome = @"C:\Users\vadaz\AppData\Local\Programs\Python\Python37";
			//Setup.UseTfKeras();
		}

		public static BaseModel LoadModel(string strpath) => BaseModel.LoadModel(strpath); //ERREUR
